...
const customerOptions = [
  ...
  { value: "Government & Institution", label: "Government", description: "Facilities and public operations" },
...
export default function BookPage() {
  ...
  return <main className="booking-page" data-audience={isGovernment ? "government" : customerType === "Business" ? "business" : "home"}>
    <header className="book-nav"><BrandMark/><span>{step} of 4 · {stepNames[step-1]}</span><a href="/" onClick={saveDraft}>Save & exit</a></header>
