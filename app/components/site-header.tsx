      ...
      <nav className="desktop-links" aria-label="Primary navigation">
        <details className="mega-menu" open={openMenu === "services"}>
          ...
          <div className="mega-panel" id="services-mega-panel" onClick={closeFromLink}>
            ...
            <div className="mega-bottom"><a href="/government">Government</a><a href="/account">Manage bookings</a><a href="/provider">Become a provider</a><a href="/jobs">Find a job</a><a href="/franchise">Own a territory</a></div>
          </div>
        </details>
